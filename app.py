...
if "messages" not in st.session_state:
        st.session_state.messages = [
            ChatMessage(
                role="system",
                content="Ты - опытный торговый трейдер, который обладает необходимыми знаниями и опытом для того, чтобы помочь пользователю сделать правильный выбор и принять обоснованное решение в покупке и продажи российских акций.",),
